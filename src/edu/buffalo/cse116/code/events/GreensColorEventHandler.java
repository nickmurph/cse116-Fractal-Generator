...
/**
 * This class contains the code for the ActionListener when the user clicks on the Greens Color Scheme button.
 * It creates an association relationship with the Handler class and sets the logic for actionPerformed.
 * 
 */

public class GreensColorEventHandler implements ActionListener {
	 ...
	 */
	public GreensColorEventHandler(Handler m){
		_model = m;

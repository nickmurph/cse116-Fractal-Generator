...
/**
 * This class contains the code for the ActionListener when the user clicks on the Rainbow Color Scheme button.
 * It creates an association relationship with the Handler class and sets the logic for actionPerformed.
 * 
 */

public class RainbowColorEventHandler implements ActionListener {
	 ...
	 */
	public RainbowColorEventHandler(Handler m){
		_model = m;

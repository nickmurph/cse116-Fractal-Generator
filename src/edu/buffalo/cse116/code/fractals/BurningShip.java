...
/**
 * This is the Burning Ship Fractal Class.
 ...
 * @author Philip  
 * */
public class BurningShip extends ImageFractals {
	/**The method that generates Burning Ship Fractals.*/
	public BurningShip(int fractalSize, int escDist, int passes, double xRangeStart, double xRangeEnd, double yRangeStart, double yRangeEnd){
	...
	public double adjY(double xCalc, double yCalc, double xCoord, double yCoord){
		return Math.abs(super.adjY(xCalc, yCalc, xCoord, yCoord))+ yCoord;
	}
}
